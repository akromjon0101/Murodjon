...
import { WatercolorSpray, GoldDecoCorner, SparkleRule, Monogram, Petal } from './decor.jsx';
...
export default function OpeningEnvelope({ onOpen }) {
  ...
  return (
    ...
    >
      <WatercolorSpray id="env-l" className="pointer-events-none absolute -left-16 -top-12 w-[58vw] max-w-[300px] opacity-40 sm:-left-4 sm:w-[26vw]" />
      <WatercolorSpray id="env-r" flip className="pointer-events-none absolute -right-16 -bottom-12 w-[58vw] max-w-[300px] opacity-30 sm:-right-4 sm:w-[26vw]" />
